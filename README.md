...
| 生徒作成ボタン                                           | 生徒の編集・削除ボタン                                      | 
| -------------------------------------------------------- | ----------------------------------------------------------- | 
| ![生徒の作成ボタン](./assets/gif/createStudentAdmin.gif) | ![生徒の編集・削除ボタン](./assets/gif/menuButtonAdmin.gif) | 

##### 生徒の作成・削除

| 生徒の作成                                    | 生徒の削除 | 
| --------------------------------------------- | ---------- | 
| ![生徒の作成](./assets/gif/createStudent.gif) | ![生徒の削除](./assets/gif/deleteStudent.gif) |
...
| 生徒の編集                                    | 科目を削除する場合 | 
| --------------------------------------------- | ---------- | 
| ![生徒の編集](./assets/gif/editStudent.gif) | ![生徒の削除](./assets/gif/editStudentSubjectDelete.gif) |
