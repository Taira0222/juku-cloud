...
### 管理者・講師の2つの権限
#### 管理画面(管理者)
管理者は生徒管理・講師管理の両方の機能にアクセスできます。
![管理画面(管理者)](./assets/gif/ManagementScreen.gif)


#### 管理画面(講師)
講師は生徒管理のみアクセスできます。
なお、講師は自分の担当生徒のみ閲覧可能です。
![管理画面(講師)](./assets/gif/TeacherScreen.gif)

#### 生徒の編集・削除・作成
管理者のみ生徒の編集・削除・作成が可能です。
|                                                                   |                                                                   | 
| ----------------------------------------------------------------- | ----------------------------------------------------------------- | 
| 生徒の編集・削除(管理者画面)                                      | 生徒の編集・削除(講師画面)                                        | 
| ![生徒の編集・削除(管理者画面)](./assets/gif/menuButtonAdmin.gif) | ![生徒の編集・削除(講師画面)](./assets/gif/menuButtonTeacher.gif) | 
